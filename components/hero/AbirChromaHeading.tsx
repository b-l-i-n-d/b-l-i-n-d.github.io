      ...
      <div className="flex items-center justify-center min-h-[2rem]">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="inline-flex flex-wrap items-center justify-center gap-2 px-3.5 py-1.5 rounded-full bg-black/4 dark:bg-white/6 border border-black/6 dark:border-white/8 text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 font-mono shadow-sm"
          >
