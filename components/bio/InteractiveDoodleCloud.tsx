...
export const InteractiveDoodleCloud: React.FC = () => {
    ...
    return (
        <div className="space-y-2.5 border-t border-black/[0.06] dark:border-white/[0.08] pt-6">
            ...
            <div
                ref={containerRef}
                className="relative w-full h-52 sm:h-56 rounded-2xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.06] dark:border-white/[0.08] p-4 overflow-hidden group select-none shadow-sm backdrop-blur-[2px] transition-all duration-300 hover:border-black/[0.12] dark:hover:border-white/[0.15]"
                style={{
