...
const InteractiveDoodleCloud = dynamic(
  () => import("./InteractiveDoodleCloud").then((m) => m.InteractiveDoodleCloud),
  { ssr: false }
);
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-white dark:bg-neutral-900/60 border border-black/6 dark:border-white/8 text-xs sm:text-sm shadow-sm text-neutral-600 dark:text-neutral-400">
          ...
          <div className="lg:col-span-8 space-y-8 text-neutral-700 dark:text-neutral-300">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base leading-relaxed text-neutral-700 dark:text-neutral-300 max-w-[65ch]">
                ...
                , a Software Engineer with a B.Sc. in Software Engineering from{" "}
                <strong className="text-neutral-900 dark:text-white font-semibold">
                  Shahjalal University of Science and Technology (SUST)
                </strong>
                . I engineer high-concurrency web platforms, tactile user interfaces, and responsive
            ...
            <div className="space-y-5 border-t border-black/6 dark:border-white/8 pt-6">
              ...
              <div ref={timelineContainerRef} className="relative space-y-6">
                ...
                >
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                      ...
                      &middot; Themeum &bull; Tutor LMS Core (v2.0 &rarr; v4.0), powering 120,000+
                      academies globally.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                      Tutor LMS 2.0 component library, state machine reducers &amp; course builder
                      cockpit.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                      ...
                      &middot; Shahjalal University of Science &amp; Technology &bull; Dept. of CSE.
                      5-year curriculum in Distributed Systems, Process Concurrency &amp;
                      Algorithms.
                    </p>
                  </div>
                </div>
