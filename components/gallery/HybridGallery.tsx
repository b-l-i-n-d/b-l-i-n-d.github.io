...
export const HybridGallery: React.FC<HybridGalleryProps> = ({ items, isEmbedded = false }) => {
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <span className="px-2 py-0.5 text-xs font-mono rounded bg-stone-100/80 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border border-black/4 dark:border-white/6 shrink-0">
                      {item.badge}
                    </span>
                  </div>
                </div>
              ...
              <div className="pt-4 mt-4 border-t border-black/6 dark:border-white/8 flex items-center justify-between text-xs sm:text-sm font-mono">
            ...
            {selectedItem && (
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative z-10 w-full max-w-2xl bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-black/8 dark:border-white/12 p-6 sm:p-8 max-h-[90vh] overflow-y-auto overscroll-contain touch-auto select-text"
                  onClick={(e) => e.stopPropagation()}
                >
                  {/* Navigation Toolbar */}
                  <div className="flex items-center justify-between gap-3 border-b border-black/6 dark:border-white/8 pb-4 mb-5 text-xs sm:text-sm font-mono">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={handleClose}
                        className="p-1.5 rounded-lg text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-black/4 dark:hover:bg-white/6 transition-colors cursor-pointer shrink-0"
                  ...
                  <AnimatePresence mode="wait" custom={navDirection}>
                    ...
                    >
                      ...
                      <div className="space-y-2.5">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {selectedItem.technologies.map((tech, idx) => (
                            <span
                              key={idx}
                              className="px-2.5 py-1 text-xs sm:text-sm font-mono bg-stone-100 dark:bg-neutral-950 text-neutral-700 dark:text-neutral-300 rounded border border-black/4 dark:border-white/6 shrink-0"
                            >
                              {tech}
                            </span>
                          ))}
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3 pt-5 border-t border-black/6 dark:border-white/8">
                        <span className="text-xs font-mono text-neutral-600 dark:text-neutral-400">
                          Navigate: [
                          <span className="text-neutral-700 dark:text-neutral-300">←</span>] [
                          <span className="text-neutral-700 dark:text-neutral-300">→</span>] &bull;
                          Close: [
  ...
  return (
    <section
      ...
      className="relative py-20 px-4 sm:px-6 lg:px-12 bg-white dark:bg-[#070708] text-neutral-900 dark:text-white border-t border-black/6 dark:border-white/8 transition-colors duration-200"
    >
