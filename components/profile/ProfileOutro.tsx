                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {profile.skillCategories.map((category, idx) => (
                                ...
                                >
                                    <h4 className="text-xs font-mono text-amber-400 font-semibold uppercase tracking-wider">
                                        {category.name}
                                    </h4>
                ...
                <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-neutral-900 via-neutral-900/90 to-neutral-950 border border-neutral-800 text-center space-y-6 relative overflow-hidden shadow-2xl">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                        <a
                            ...
                            className="px-6 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-bold text-sm font-mono transition-all shadow-lg"
                        >
