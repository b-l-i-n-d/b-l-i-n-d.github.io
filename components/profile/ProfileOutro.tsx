...
export const ProfileOutro: React.FC<ProfileOutroProps> = ({ profile }) => {
    return (
        <section
            ...
            className="relative py-24 px-4 sm:px-6 lg:px-12 bg-stone-50 dark:bg-[#070707] text-neutral-900 dark:text-white border-t border-black/[0.06] dark:border-white/[0.08] transition-colors duration-200"
        >
            ...
            <div className="relative z-10 max-w-6xl mx-auto space-y-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
                                Engineering high-scale UI systems, tactile state machines, and resilient architectures.
                            </h2>
                        ...
                        <div className="pt-8 border-t border-black/[0.06] dark:border-white/[0.08] space-y-6">
                            ...
                            <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-300 leading-relaxed">
                                When not architecting software, I spend significant time in competitive video games. Currently active in{" "}
                                <strong className="text-neutral-900 dark:text-white font-semibold">Call of Duty: Warzone</strong> (playing as designated Squad Sniper) and precision pursuit titles like{" "}
                            ...
                            <div className="space-y-4 pt-1">
                                ...
                                <div className="group flex items-start gap-4 p-3 -mx-3 rounded-xl hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors duration-150">
                                    <div className="w-9 h-9 rounded-lg bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center shrink-0 text-[#ff1744] mt-0.5">
                                    ...
                                    <div className="space-y-1 flex-1">
                                        <div className="flex items-baseline justify-between gap-2 flex-wrap">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs text-neutral-400 font-mono">&bull; Squad Sniper</span>
                                            </div>
                                        ...
                                        <p className="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
                                            Designated squad sniper across Verdansk &amp; Urzikstan drops: first-shot accuracy, long-range overwatch, bullet velocity prediction, high-tick squad comms, and clutch endgame rotations under pressure.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="group flex items-start gap-4 p-3 -mx-3 rounded-xl hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors duration-150">
                                    ...
                                    <div className="space-y-1 flex-1">
                                        ...
                                        <p className="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
                                            High-speed vehicle pursuit, dynamic trajectory anticipation, and kinetic drift physics at zero latency.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <blockquote className="border-l-2 border-[#ff1744]/40 pl-4 py-1 text-xs sm:text-sm italic text-neutral-500 dark:text-neutral-400">
                                &ldquo;Reading 150-player chaotic lobbies as a sniper and executing high-speed pursuits demands the exact same muscle memory as building zero-latency UI: split-second state transitions, frame-perfect anticipation, and zero tolerance for dropped frames.&rdquo;
                            </blockquote>
                        </div>
                        ...
                        <div className="pt-8 border-t border-black/[0.06] dark:border-white/[0.08] space-y-4">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="px-4 py-2.5 rounded-xl bg-black/[0.03] dark:bg-white/[0.04] hover:bg-black/[0.06] dark:hover:bg-white/[0.08] border border-black/[0.06] dark:border-white/[0.08] text-xs sm:text-sm font-medium text-neutral-800 dark:text-neutral-200 transition-colors flex items-center gap-2 active:scale-[0.97]"
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        ...
                        <div className="flex items-center gap-5 pb-8 border-b border-black/[0.06] dark:border-white/[0.08]">
                            <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden bg-neutral-100 dark:bg-neutral-800 border border-black/[0.08] dark:border-white/[0.10] shrink-0 group">
                                <Image
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Location */}
                            <div className="flex items-center justify-between text-xs sm:text-sm pt-2 border-t border-black/[0.04] dark:border-white/[0.06]">
                                    ...
                                    <div key={idx} className="space-y-2">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {category.skills.map((skill, sIdx) => (
                                                <span
                                                    key={sIdx}
                                                    className="px-2 py-0.5 rounded-md text-[11px] sm:text-xs font-mono bg-black/[0.03] dark:bg-white/[0.04] text-neutral-700 dark:text-neutral-300 border border-black/[0.04] dark:border-white/[0.06] hover:border-[#ff1744]/30 transition-colors"
                                                >
                                                    {skill}
                                                </span>
                                            ))}
