...
export const MouseIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  className,
...
export const LockIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const SearchIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const ClientIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const BackendIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const MapPinIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const SocialIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const ToolsIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const WorkIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
...
export const SchoolIcon = ({ size = 24, width, height, className, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    viewBox="0 0 24 24"
    width={size || width}
