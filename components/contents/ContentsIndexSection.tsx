...
const DEFAULT_COLUMNS: ContentsColumn[] = [
  ...
  },
  {
    id: "three",
    numberScript: "Three :",
    title: "Track Record & Dossier",
    items: [
      {
        id: "career-track",
        title: "Career Track Record",
        subtitle: "Senior Software Engineer · Ollyo",
        subtitlePosition: "above",
        targetId: "experience",
        dotsCount: 1,
      },
      {
        id: "bio-dossier",
        title: "Engineering Philosophy & Bio",
      ...
      },
      {
        ...
        subtitle: "Architecture, Frontend, Systems & Security",
        subtitlePosition: "below",
        targetId: "profile",
        dotsCount: 3,
      },
