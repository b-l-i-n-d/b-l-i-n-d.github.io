...
export const ChapterScrubber: React.FC<ChapterScrubberProps> = ({ chapters }) => {
    ...
    return (
        <>
            ...
            <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 md:hidden flex items-center gap-2 bg-white/85 dark:bg-neutral-900/85 backdrop-blur-xl px-4 py-2 rounded-full border border-black/[0.06] dark:border-white/[0.10] shadow-craft-elevated pointer-events-auto">
