...
export const ArchitectureGraph: React.FC<ArchitectureGraphProps> = ({ data }) => {
    const [selectedNodeId, setSelectedNodeId] = useState<string>(() => data.columns[0]?.nodeIds[0] ?? "");
                                ...
                                <div className="space-y-2.5">
                                    {nodes.map((node) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center justify-between">
                                                    <span className={`text-xs font-mono px-2 py-0.5 rounded ${accent.badge} font-semibold shrink-0`}>
                                                        {node.badge}
                                                    </span>
                                                    {isSelected && (
