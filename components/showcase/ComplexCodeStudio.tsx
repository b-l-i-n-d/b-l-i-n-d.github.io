...
export const ComplexCodeStudio: React.FC<ComplexCodeStudioProps> = ({ modules }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative rounded-2xl overflow-hidden border border-black/8 dark:border-white/10 bg-[#0d1117] text-[#e6edf3] font-mono text-xs sm:text-sm shadow-2xl">
