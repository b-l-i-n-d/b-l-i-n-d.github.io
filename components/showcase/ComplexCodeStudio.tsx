...
import { FileCode, GitPullRequest, ExternalLink, Cpu } from "lucide-react";
...
export const ComplexCodeStudio: React.FC<ComplexCodeStudioProps> = ({ modules }) => {
  ...
  return (
    <div className="space-y-4">
      {/* File Switcher Tabs */}
      <div className="flex items-center gap-2 p-2 rounded-2xl bg-stone-100/70 dark:bg-neutral-900/60 border border-black/6 dark:border-white/8">
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl font-mono font-medium transition-colors flex items-center gap-2 shrink-0 border ${
                    isSelected
                      ? "bg-white dark:bg-neutral-950 text-neutral-900 dark:text-white border-black/10 dark:border-white/15 shadow-sm"
                      : "text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white border-transparent hover:border-black/6 dark:hover:border-white/8 hover:bg-white/50 dark:hover:bg-neutral-800/40"
                  }`}
                >
                  <FileCode
      ...
      {/* Description Card */}
      <div className="p-4 rounded-xl bg-white/70 dark:bg-white/2 border border-black/[0.05] dark:border-white/6 text-xs sm:text-sm space-y-1 min-h-[118px]">
      ...
      <div className="relative rounded-2xl overflow-hidden border border-black/8 dark:border-white/10 bg-stone-100/90 dark:bg-[#0d1117] text-neutral-900 dark:text-[#e6edf3] font-mono text-xs sm:text-sm shadow-2xl">
        {/* Window Chrome Header */}
        <div className="flex items-center justify-between gap-2 px-4 py-2.5 bg-stone-200/70 dark:bg-[#161b22] border-b border-black/6 dark:border-[#30363d]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="text-xs text-neutral-700 dark:text-[#8b949e] ml-2 font-mono flex items-center gap-1.5 shrink-0 font-medium">
        ...
        {/* Code Body */}
        <div className="p-4 overflow-auto h-[520px] lg:h-[580px] leading-relaxed select-text bg-stone-50/50 dark:bg-[#0d1117]">
          {language && SUPPORTED_LANGUAGES.has(language) ? (
            ...
            <pre className="text-xs sm:text-sm font-mono leading-relaxed min-w-max">
